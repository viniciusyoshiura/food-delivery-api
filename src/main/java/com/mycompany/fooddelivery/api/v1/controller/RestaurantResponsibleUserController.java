...
import com.mycompany.fooddelivery.api.v1.openapi.controller.RestaurantResponsibleUserControllerOpenApi;
...
@RestController
@RequestMapping(path = "/v1/restaurants/{restaurantId}/responsibles", produces = MediaType.APPLICATION_JSON_VALUE)
